                ...
                <Table.Row key={i}>
                    ...
                    <Table.Cell>
                        <Header style={css_config.table_Cell_Heading}>
                            Active Directory
                            <HeaderSubHeader style={css_config.table_Cell_text}>
                                Azure Active Directory provides an identity platform with enhanced security, access
                                management, scalability, and reliability for connecting users with all the apps they
                                need. </HeaderSubHeader>
                        </Header>
                    </Table.Cell>
                </Table.Row>
            );
